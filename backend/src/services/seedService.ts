...
const SAMPLE_QUOTES: { config: QuoteConfiguration; status: 'DRAFT' | 'FINAL' }[] = [
  {
    ...
    config: {
      ...
      solutionCoverage: [
        ...
        'Real-time edge/GPU inference pipeline',
        'MES / quality system integration',
        'Inspection dashboard & alerting',
      ],
      warrantyPeriod: 12,
      warrantyUnit: 'months',
      ...
      hardwareBom: [
        { item: 'Edge GPU inference server', partNumber: 'EGX-A100-01', quantity: 2, unitPrice: 7500 },
        { item: 'Industrial enclosure & rack kit', partNumber: 'ENC-IND-4U', quantity: 1, unitPrice: 3500 },
      ],
    },
  },
  {
